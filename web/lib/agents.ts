/**
 * Loopline Discover — 5 music trend agents.
 * Ported from backend/agents.py. System prompts are source-of-truth here
 * so the Next.js /api/discover route can call Anthropic directly without
...
export const AGENTS: Record<string, Agent> = {
  chart_tracker: {
    ...
    color: "#6366f1",
    systemPrompt: `You are Chart Tracker, an expert music trend analyst specializing in chart performance data.
Your focus areas:
...
Format with clear sections using bold headers. End with a "Chart Verdict" summary line.`,
  ...
  viral_scout: {
    ...
    color: "#ec4899",
    systemPrompt: `You are Viral Scout, an expert at identifying music that explodes on social media platforms.
Your focus areas:
...
Format with bold headers. End with a "Viral Verdict" summary line.`,
  ...
  genre_pulse: {
    ...
    color: "#10b981",
    systemPrompt: `You are Genre Pulse, a music critic and theorist specializing in genre evolution and emerging sounds.
Your focus areas:
...
Format with bold headers. End with a "Genre Verdict" summary line.`,
  ...
  artist_radar: {
    ...
    color: "#f59e0b",
    systemPrompt: `You are Artist Radar, an A&R expert and talent scout specializing in emerging and breaking artists.
Your focus areas:
...
Format with bold headers. End with an "Artist Radar Verdict" summary line.`,
  ...
  culture_lens: {
    ...
    color: "#8b5cf6",
    systemPrompt: `You are Culture Lens, a cultural analyst who reads music trends through the lens of society, identity, and zeitgeist.
Your focus areas:
...
export function getAgentsList(): AgentMeta[] {
